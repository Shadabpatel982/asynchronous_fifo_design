...
A complete, documented implementation of a Asynchronous FIFO based on the Cliff Cummings SNUG 2002 standard architecture. Built for learning and reference — covers full theory, design, waveforms, flowcharts, and verified RTL.
...
│   ├── block_diagram                ← full architecture diagram
...
│   ├── 2_ff_synch                   ←  synchronize wptr & rptr to read & write clock domain
│
├── tb/
│   └── case_1_tb.v                  ← to verify full and empty flag and read and write operation
│   └── case_2_tb.v                  ← for simultaneous read and write operation 
│   └── ff_synch_tb.v                ← 2 ff synchronizer 
│   └── fifo_mem_tb.v                ← Dual port RAM 
│   └── rptr_empty_tb.v              ← read pointer + empty flag
│   ├── wptr_full_tb.v               ← write pointer + full flag
│   
├── sim/
